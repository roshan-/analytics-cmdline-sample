...
public class HelloAnalyticsApiSample {
  ...
  private static GaData executeDataQuery(Analytics analytics, String profileId) throws IOException {
    return analytics.data().ga().get("ga:96667371",
        "2015-01-01", // Start date.
        "2015-01-31", // End date.
        "ga:totalEvents") // Metrics.
        .setDimensions("ga:hour,ga:minute,ga:dimension10,ga:eventCategory,ga:eventAction,ga:eventLabel")
        .setSort("ga:hour,ga:minute")
        .setMaxResults(50)
        .execute();
  }
